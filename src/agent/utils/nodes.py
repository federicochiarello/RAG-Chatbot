...
follow_up_questions_prompt = """You are an AI language model assistant. Your task is to write 3 follow-up questions,
...
def generate_or_rewrite_query(state):
    ...
    loop_step_retrieve = state.get("loop_step_retrieve")
